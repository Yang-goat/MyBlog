...
<div class="language-pseudo" data-highlighter="shiki" data-ext="pseudo" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre class="shiki shiki-themes one-light one-dark-pro vp-code" v-pre=""><code class="language-pseudo"><span class="line"><span>Algorithm GeneticAlgorithm</span></span>
...
<div class="language-pseudo" data-highlighter="shiki" data-ext="pseudo" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre class="shiki shiki-themes one-light one-dark-pro vp-code" v-pre=""><code class="language-pseudo"><span class="line"><span>Algorithm EvolutionStrategy</span></span>
...
<div class="language-pseudo" data-highlighter="shiki" data-ext="pseudo" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre class="shiki shiki-themes one-light one-dark-pro vp-code" v-pre=""><code class="language-pseudo"><span class="line"><span>Algorithm EvolutionaryProgramming</span></span>
