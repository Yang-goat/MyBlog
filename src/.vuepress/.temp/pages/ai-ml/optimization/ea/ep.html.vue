<template><div><h1 id="进化规划-ep" tabindex="-1"><a class="header-anchor" href="#进化规划-ep"><span>进化规划（EP）</span></a></h1>
...
<hr>
<h2 id="二、算法流程图" tabindex="-1"><a class="header-anchor" href="#二、算法流程图"><span>二、算法流程图</span></a></h2>
<Mermaid id="mermaid-102" code=""></Mermaid><h2 id="三、伪代码示例" tabindex="-1"><a class="header-anchor" href="#三、伪代码示例"><span>三、伪代码示例</span></a></h2>
...
<h3 id="_4-3-竞争选择-tournament-selection" tabindex="-1"><a class="header-anchor" href="#_4-3-竞争选择-tournament-selection"><span>4.3 竞争选择（Tournament Selection）</span></a></h3>
...
<h3 id="_4-4-自适应机制-self-adaptation" tabindex="-1"><a class="header-anchor" href="#_4-4-自适应机制-self-adaptation"><span>4.4 自适应机制（Self-Adaptation）</span></a></h3>
