<template><div><h1 id="linux-入门" tabindex="-1"><a class="header-anchor" href="#linux-入门"><span>Linux 入门</span></a></h1>
...
<tbody>
<tr>
<td><strong>内核 (Kernel)</strong></td>
<td>系统核心，负责内存、进程、设备等底层管理</td>
</tr>
<tr>
<td><strong>Shell</strong></td>
<td>用户与系统的交互层（命令行解释器）</td>
</tr>
<tr>
<td><strong>文件系统 (File System)</strong></td>
<td>组织与存储数据的结构体系</td>
</tr>
<tr>
<td><strong>用户空间 (User Space)</strong></td>
<td>运行应用程序的区域</td>
</tr>
<tr>
<td><strong>系统工具</strong></td>
<td>提供配置、维护与开发的命令工具</td>
</tr>
</tbody>
</table>
...
<tr>
<td><code v-pre>/bin</code></td>
<td>基本命令，如 <code v-pre>ls</code>、<code v-pre>cp</code>、<code v-pre>mv</code></td>
</tr>
<tr>
<td><code v-pre>/sbin</code></td>
...
<td>设备文件（硬盘、USB、终端等）</td>
</tr>
<tr>
<td><code v-pre>/proc</code></td>
<td>虚拟文件系统，保存内核与进程信息</td>
</tr>
<tr>
...
<li>文件（普通文件）</li>
<li>目录（文件夹）</li>
<li>设备（如 <code v-pre>/dev/sda</code>）</li>
...
<tbody>
<tr>
<td><code v-pre>sshd</code></td>
<td>远程登录服务</td>
</tr>
<tr>
<td><code v-pre>systemd</code></td>
<td>系统初始化与服务管理</td>
</tr>
<tr>
<td><code v-pre>crond</code></td>
<td>定时任务服务</td>
</tr>
</tbody>
</table>
...
<tr>
<td>Ubuntu / Debian</td>
<td><code v-pre>APT</code></td>
<td><code v-pre>.deb</code></td>
</tr>
<tr>
<td>Fedora / RHEL / CentOS</td>
<td><code v-pre>DNF</code> / <code v-pre>YUM</code></td>
<td><code v-pre>.rpm</code></td>
</tr>
<tr>
<td>Arch Linux</td>
<td><code v-pre>pacman</code></td>
<td><code v-pre>.pkg.tar.zst</code></td>
</tr>
<tr>
<td>openSUSE</td>
<td><code v-pre>zypper</code></td>
<td><code v-pre>.rpm</code></td>
</tr>
</tbody>
</table>
...
<ul>
<li>网络接口通常命名为 <code v-pre>eth0</code>、<code v-pre>ens33</code>、<code v-pre>wlan0</code> 等。</li>
<li>每个接口可绑定多个 IP 地址与端口。</li>
...
<ul>
<li>可安全登录远程主机并执行命令</li>
<li>支持密钥登录、隧道代理与自动化脚本调用</li>
<li>取代传统的 Telnet 与 FTP，提供更高安全性</li>
</ul>
...
<li><strong>SFTP（Secure File Transfer Protocol）</strong>：提供交互式传输接口</li>
<li><strong>rsync</strong>：支持断点续传、差异同步和批量备份</li>
</ul>
...
<ul>
<li>全命令行可控，无需图形界面</li>
<li>网络层完全开放，适合开发与调试</li>
<li>系统级服务（如 SSH、Firewall、Routing）高度集成</li>
<li>可靠、安全、灵活，适合服务器与云环境</li>
</ul>
<hr>
</div></template>
