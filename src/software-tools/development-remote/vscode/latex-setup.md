...
[跳转到相关教程](./multi-language-setup.md#二、vscode多配置文件)

## 三、下载必备插件

![](./assets/latex-extensions.png)
...
![](./assets/edit-latex-settings.png)
