...
redirectFrom:
  - "/guides/Zotero.html"
  - "/guides/paper-knowledge/Zotero.html"
title: Zotero：论文管理与参考文献引用工具
icon: book-open
date: 2025-10-02
order: 1
star: 1
...
![](./assets/export-items-1.png)

![ =200x](./assets/export-items-2.png)
