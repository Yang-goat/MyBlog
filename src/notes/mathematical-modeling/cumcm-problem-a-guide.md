...
::: info
MATLAB在数值计算与仿真上面执行速度比Python快，且使用[并行计算](/notes/programming-languages/matlab/parallel.html)比Python方便，在当前赛题趋势上看，赛题计算量在逐年上升，更推荐掌握MATLAB
:::
